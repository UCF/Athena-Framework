...
<a class="btn btn-primary" href="{{ site.baseurl }}{% link getting-started/quick-start.md %}">Learn More</a> <a class="btn btn-primary" href="{{ site.baseurl }}{% link getting-started/download.md %}">Download</a>
