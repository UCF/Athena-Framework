...
var Button = function ($) {
  ...
  return Button;
}(jQuery); // NOTE: Athena intentionally does not include Bootstrap's carousel component.
...
var Collapse = function ($) {
  ...
  function () {
    ...
    var _proto3 = Collapse.prototype;
    ...
    _proto3.setTransitioning = function setTransitioning(isTransitioning) {
    ...
    _proto3._getDimension = function _getDimension() {
      var hasWidth = $(this._element).hasClass(Dimension.WIDTH);
      return hasWidth ? Dimension.WIDTH : Dimension.HEIGHT;
    };

    _proto3._getParent = function _getParent() {
      var _this5 = this;
    ...
    _proto3._addAriaAndCollapsedClass = function _addAriaAndCollapsedClass(element, triggerArray) {
      if (element) {
...
var Dropdown = function ($) {
  ...
  function () {
    ...
    var _proto4 = Dropdown.prototype;
  ...
  function () {
    ...
    _proto5.show = function show(relatedTarget) {
      ...
      $(this._element).on(Event.CLICK_DISMISS, Selector.DATA_DISMISS, function (event) {
        return _this6.hide(event);
      });
      $(this._dialog).on(Event.MOUSEDOWN_DISMISS, function () {
        $(_this6._element).one(Event.MOUSEUP_DISMISS, function (event) {
          if ($(event.target).is(_this6._element)) {
    ...
    _proto5.hide = function hide(event) {
      ...
      if (transition) {
        $(this._element).one(Util.TRANSITION_END, function (event) {
          return _this7._hideModal(event);
        }).emulateTransitionEnd(TRANSITION_DURATION);
      } else {
        this._hideModal();
      }
    ...
    _proto5._setResizeEvent = function _setResizeEvent() {
      ...
      if (this._isShown) {
        $(window).on(Event.RESIZE, function (event) {
          return _this11._handleUpdate(event);
        });
      } else {
    ...
    _proto5._hideModal = function _hideModal() {
      var _this12 = this;
      ...
      this._showBackdrop(function () {
        ...
        _this12._resetAdjustments();

        _this12._resetScrollbar();

        $(_this12._element).trigger(Event.HIDDEN);
      });
    };
    ...
    _proto5._showBackdrop = function _showBackdrop(callback) {
      ...
      if (this._isShown && this._config.backdrop) {
        ...
        $(this._element).on(Event.CLICK_DISMISS, function (event) {
          if (_this13._ignoreBackdropClick) {
            _this13._ignoreBackdropClick = false;
            return;
          }
          ...
          if (_this13._config.backdrop === 'static') {
    ...
    _proto5._handleUpdate = function _handleUpdate() {
      this._adjustDialog();
    };
...
var ScrollSpy = function ($) {
  ...
  function () {
    ...
    var _proto6 = ScrollSpy.prototype;
    ...
    _proto6.refresh = function refresh() {
      ...
      targets.map(function (element) {
        ...
        _this16._offsets.push(item[0]);

        _this16._targets.push(item[1]);
      });
    };
    ...
    _proto6._getScrollTop = function _getScrollTop() {
      return this._scrollElement === window ? this._scrollElement.pageYOffset : this._scrollElement.scrollTop;
    };

    _proto6._getScrollHeight = function _getScrollHeight() {
      return this._scrollElement.scrollHeight || Math.max(document.body.scrollHeight, document.documentElement.scrollHeight);
    };

    _proto6._getOffsetHeight = function _getOffsetHeight() {
      return this._scrollElement === window ? window.innerHeight : this._scrollElement.offsetHeight;
    };

    _proto6._process = function _process() {
    ...
    _proto6._activate = function _activate(target) {
...
var Tab = function ($) {
  ...
  function () {
    ...
    _proto7._activate = function _activate(element, container, callback) {
      var _this18 = this;
    ...
    _proto7._transitionComplete = function _transitionComplete(element, active, isTransitioning, callback) {
      if (active) {
...
var Tooltip = function ($) {
  ...
  function () {
    ...
    _proto8.cleanupTether = function cleanupTether() {
      if (this._tether) {
