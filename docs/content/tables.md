...
Using the most basic table markup, here's how `.table`-based tables look in Athena. **All table styles are inherited in Athena**, meaning any nested tables will be styled in the same manner as the parent.
